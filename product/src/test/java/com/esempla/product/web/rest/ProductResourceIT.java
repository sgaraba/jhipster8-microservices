...
import static com.esempla.product.web.rest.TestUtil.sameNumber;
...
class ProductResourceIT {
    ...
    private static final Sise DEFAULT_SISE = Sise.S;
    private static final Sise UPDATED_SISE = Sise.M;
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getSise()).isEqualTo(DEFAULT_SISE);
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].sise").value(hasItem(DEFAULT_SISE.toString())))
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.sise").value(DEFAULT_SISE.toString()))
    ...
    @Test
    @Transactional
    void getAllProductsBySiseIsEqualToSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);

        // Get all the productList where sise equals to DEFAULT_SISE
        defaultProductShouldBeFound("sise.equals=" + DEFAULT_SISE);

        // Get all the productList where sise equals to UPDATED_SISE
        defaultProductShouldNotBeFound("sise.equals=" + UPDATED_SISE);
    }

    @Test
    @Transactional
    void getAllProductsBySiseIsInShouldWork() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);

        // Get all the productList where sise in DEFAULT_SISE or UPDATED_SISE
        defaultProductShouldBeFound("sise.in=" + DEFAULT_SISE + "," + UPDATED_SISE);

        // Get all the productList where sise equals to UPDATED_SISE
        defaultProductShouldNotBeFound("sise.in=" + UPDATED_SISE);
    }

    @Test
    @Transactional
    void getAllProductsBySiseIsNullOrNotNull() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);

        // Get all the productList where sise is not null
        defaultProductShouldBeFound("sise.specified=true");

        // Get all the productList where sise is null
        defaultProductShouldNotBeFound("sise.specified=false");
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        assertThat(testProduct.getSise()).isEqualTo(UPDATED_SISE);
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.description(UPDATED_DESCRIPTION).price(UPDATED_PRICE);
