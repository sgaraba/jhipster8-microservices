...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.esempla.store.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.esempla.store.security.DomainUserDetailsService", "createSpringSecurityUser");
